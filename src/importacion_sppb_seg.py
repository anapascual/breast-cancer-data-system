...
catalogo_variables = {
    ...
    'id_visita' : 'id_visita',
    'test1_equil_SEG' : 'sppb_pies_juntos',
    'test2_equil_SEG' : 'sppb_semi_tandem',
    'test3_equil_SEG' : 'sppb_tandem',
    'puntos_speed test_SEG' : 'sppb_velocidad_marcha',
    'Pretest_silla_SEG' : 'sppb_capacidad_levantarse',
    'test_silla_SEG_SEG' : 'sppb_levantarse_5_reps',
    'test_silla_SEG' : 'sppb_total_silla',
    #'pto_total_sppb_SEG' : 'sppb_total',
    'clasifSPPB_SEG' : 'sppb_clasificacion',
    'Tiempo_get_up_SEG': 'tiempo_levantarse',
    'calsif_get_up_SEG': 'clasificacion_levantarse'
}
...
for index, row in excel_ordenado.iterrows():
    ...
    row_without_observations = row.drop(labels=['codigo_mamavida', 'id_visita', 'record_id', 'redcap_event_name', 'redcap_repeat_instrument', 'redcap_repeat_instance', 'test_sppb_test_get_up_and_go_complete'])
    ...
    elif row_without_observations.sum() == 0.0:
        excel_ordenado.at[index, 'test_sppb_test_get_up_and_go_complete'] = ''
...
datos_sppb_seg = "datos_sppb_seg.csv";
excel_ordenado.to_csv(datos_sppb_seg, index=False);
