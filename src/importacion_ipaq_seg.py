...
catalogo_variables = {
    ...
    'id_visita' : 'id_visita',
    '1DIAS_activfisica_intensa_SEG' : 'actividad_intensa_dias',
    '1activfisica_intensa_SEG' : 'realizo_actividad_intensa',
    '2horas_actvfisica_intensa_SEG' : 'actividad_intensa_horas',
    '2min_actvfisica_intensa_SEG' : 'actividad_intensa_minutos',
    '2no sabe_intensa_SEG' : 'actividad_intensa_nsnc',
    '3DIAS_activfisica_moderada_SEG' : 'actividad_moderada_dias',
    '3activfisica_moderada_SEG' : 'realizo_actividad_moderada',
    '4horas_actvfisica_moderada_SEG' : 'actividad_moderada_horas',
    '4min_actvfisica_moderada_SEG' : 'actividad_moderada_minutos',
    '4activfisica_moderada_SEG' : 'actividad_moderada_nsnc',
    '5Dias_andar_10m_SEG' : 'caminar_dias',
    '5activfisica_10min_SEG' : 'realizo_caminar',
    '6horas_CaMINAR_día_SEG' : 'caminar_horas',
    '6min_caminar_min_SEG' : 'caminar_minutos',
    '6CAMINAR_SEG' : 'caminar_nsnc',
    '7horas_sENTADOdía_SEG' : 'sentado_horas',
    '7min_sENTADOdia_SEG' : 'sentado_minutos', 
    '7_sENTADO_SEG' : 'sentado_nsnc',
...
excel_transformado[columnas_realizo] = excel_transformado[columnas_realizo].replace({1: 0, 2: np.nan})
...
datos_ipaq_seg = "datos_ipaq_seg.csv";
excel_ordenado.to_csv(datos_ipaq_seg, index=False);
